...
namespace REST_API.Utilities
{
    public class DbManager
    {
        ...
        private const string connectionString = "server=kufrko-rest-api-mysqldbserver.mysql.database.azure.com;uid=kufrko@kufrko-rest-api-mysqldbserver;pwd=mH$D62d)^*uNO*B*0gW5uIeL7;database=chat;charset=utf8mb4";
